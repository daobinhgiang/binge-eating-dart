...
exports.getQuizAnswerKey = getQuizAnswerKey;
exports.isValidQuizId = isValidQuizId;
...
function getQuizAnswerKey(quizId) {
    return exports.QUIZ_ANSWERS[quizId] || null;
}
/**
 * Validate if a quiz ID exists in the answer key
 */
function isValidQuizId(quizId) {
    return quizId in exports.QUIZ_ANSWERS;
}
//# sourceMappingURL=quiz-answers.js.map
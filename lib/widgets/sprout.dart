...
class SproutPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Left leaf
    canvas.save();
    canvas.translate(size.width * 0.45, size.height * 0.6);
    canvas.rotate(-30 * math.pi / 180);
    paint.color = const Color(0xFF9CCC65);
    canvas.drawOval(
      const Rect.fromCenter(center: Offset.zero, width: 16, height: 24),
      paint,
    );
    canvas.restore();
    ...
    // Right leaf
    canvas.save();
    canvas.translate(size.width * 0.55, size.height * 0.58);
    canvas.rotate(25 * math.pi / 180);
    paint.color = const Color(0xFF8BC34A);
    canvas.drawOval(
      const Rect.fromCenter(center: Offset.zero, width: 14, height: 22),
      paint,
    );
    canvas.restore();
    ...
    canvas.drawLine(
      Offset(size.width * 0.45, size.height * 0.54),

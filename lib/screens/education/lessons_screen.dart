...
class _LessonsScreenState extends ConsumerState<LessonsScreen> {
  ...
  void _updateCurrentSection() {
    ...
    const double headerHeight = 150.0; // Reduced to match compact sticky header height
  ...
  Widget _buildStickyHeader(Stage stage, Chapter chapter) {
    return Container(
      height: 150.0, // Reduced height to cover up to bottom of Stage Chapter tile
          ...
          data: (completedLessons) {
            return Column(
              children: List.generate(chapter.lessons.length, (index) {
                ...
                } else if (lesson.id == 'lesson_s2_0_3') {
                  return Column(
                    children: [
                      SizedBox(
                        height: 200, // Adequate height to show full larger avatar
                ...
                } else if (lesson.id == 'lesson_s2_0_6') {
                  return Column(
                    children: [
                      SizedBox(
                        height: 200, // Adequate height to show full larger avatar
                ...
                } else if (lesson.id == 'lesson_s2_1_3') {
                  return Column(
                    children: [
                      SizedBox(
                        height: 200, // Adequate height to show full larger avatar
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Opacity(
                                    opacity: 0.3, // Same transparency as other avatars (30% opacity)
                                    child: Image.asset(
                                      'assets/lessons/avatars/avatar_8.png',
                                      fit: BoxFit.cover,
                                      errorBuilder: (context, error, stackTrace) {
                                        // Fallback to a simple icon if image fails to load
                                        return Container(
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Opacity(
                                    opacity: 0.3, // Same transparency as other avatars (30% opacity)
                                    child: Image.asset(
                                      'assets/lessons/avatars/avatar_9.png',
                                      fit: BoxFit.cover,
                                      errorBuilder: (context, error, stackTrace) {
                                        // Fallback to a simple icon if image fails to load
                                        return Container(
                ...
                } else if (lesson.id == 'lesson_s2_2_5_1') {
                  return Column(
                    children: [
                      SizedBox(
                        height: 200, // Adequate height to show full larger avatar
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Opacity(
                                    opacity: 0.3, // Same transparency as other avatars (30% opacity)
                                    child: Image.asset(
                                      'assets/lessons/avatars/avatar_10.png',
                                      fit: BoxFit.cover,
                                      errorBuilder: (context, error, stackTrace) {
                                        // Fallback to a simple icon if image fails to load
                                        return Container(
                ...
                } else if (lesson.id == 'lesson_s2_3_2_1') {
                  return Column(
                    children: [
                      SizedBox(
                        height: 200, // Adequate height to show full larger avatar
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Opacity(
                                    opacity: 0.3, // Same transparency as other avatars (30% opacity)
                                    child: Image.asset(
                                      'assets/lessons/avatars/avatar_11.png',
                                      fit: BoxFit.cover,
                                      errorBuilder: (context, error, stackTrace) {
                                        // Fallback to a simple icon if image fails to load
                                        return Container(
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Opacity(
                                    opacity: 0.3, // Same transparency as other avatars (30% opacity)
                                    child: Image.asset(
                                      'assets/lessons/avatars/avatar_12.png',
                                      fit: BoxFit.cover,
                                      errorBuilder: (context, error, stackTrace) {
                                        // Fallback to a simple icon if image fails to load
                                        return Container(
                ...
                } else if (lesson.id == 'lesson_s2_6_3') {
                  return Column(
                    children: [
                      SizedBox(
                        height: 200, // Adequate height to show full larger avatar
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Opacity(
                                    opacity: 0.3, // Same transparency as other avatars (30% opacity)
                                    child: Image.asset(
                                      'assets/lessons/avatars/avatar_13.png',
                                      fit: BoxFit.cover,
                                      errorBuilder: (context, error, stackTrace) {
                                        // Fallback to a simple icon if image fails to load
                                        return Container(
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Opacity(
                                    opacity: 0.3,
                                    child: Image.asset(
                                      'assets/lessons/avatars/avatar_18.png',
                                      fit: BoxFit.cover,
                                      errorBuilder: (context, error, stackTrace) {
                                        return Container(
                                          decoration: BoxDecoration(
                ...
                } else if (lesson.id == 'lesson_s2_7_2') {
                  return Column(
                    children: [
                      SizedBox(
                        height: 200, // Adequate height to show full larger avatar
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Opacity(
                                    opacity: 0.3, // Same transparency as other avatars (30% opacity)
                                    child: Image.asset(
                                      'assets/lessons/avatars/avatar_16.png',
                                      fit: BoxFit.cover,
                                      errorBuilder: (context, error, stackTrace) {
                                        // Fallback to a simple icon if image fails to load
                                        return Container(
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Opacity(
                                    opacity: 0.3, // Same transparency as other avatars (30% opacity)
                                    child: Image.asset(
                                      'assets/lessons/avatars/avatar_15.png',
                                      fit: BoxFit.cover,
                                      errorBuilder: (context, error, stackTrace) {
                                        return Container(
                                          decoration: BoxDecoration(
...
class _StickyHeaderDelegate extends SliverPersistentHeaderDelegate {
  ...
  @override
  double get minExtent => 150.0; // Reduced to match compact sticky header height

  @override
  double get maxExtent => 150.0; // Reduced to match compact sticky header height

...
class _AccountabilityPartnerScreenState extends ConsumerState<AccountabilityPartnerScreen> {
  ...
  void _addWelcomeMessage() {
    setState(() {
      _messages.add(ChatMessage(
        ...
        content: "I'm your accountability partner, here to support you on your recovery journey. I'll help you stay committed to your goals, check in on your progress, and provide gentle accountability when you need it. What would you like to work on together today?",
        isUser: false,
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      // Get AI response for accountability

...
class LessonS231Screen extends StatefulWidget {
  const LessonS231Screen({super.key});

  @override
  State<LessonS231Screen> createState() => _LessonS231ScreenState();
}

class _LessonS231ScreenState extends State<LessonS231Screen> {

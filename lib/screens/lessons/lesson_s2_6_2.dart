...
class LessonS262Screen extends StatefulWidget {
  const LessonS262Screen({super.key});

  @override
  State<LessonS262Screen> createState() => _LessonS262ScreenState();
}

class _LessonS262ScreenState extends State<LessonS262Screen> {

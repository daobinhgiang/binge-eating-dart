...
class LessonS251Screen extends StatefulWidget {
  const LessonS251Screen({super.key});

  @override
  State<LessonS251Screen> createState() => _LessonS251ScreenState();
}

class _LessonS251ScreenState extends State<LessonS251Screen> {

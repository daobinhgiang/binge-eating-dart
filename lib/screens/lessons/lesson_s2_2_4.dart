...
class LessonS224Screen extends StatefulWidget {
  const LessonS224Screen({super.key});

  @override
  State<LessonS224Screen> createState() => _LessonS224ScreenState();
}

class _LessonS224ScreenState extends State<LessonS224Screen> {
  ...
  Future<void> _loadLesson() async {
    try {
      ...
      final lesson = stage2.chapters[2].lessons[3];

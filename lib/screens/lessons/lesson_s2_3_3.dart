...
class LessonS233Screen extends StatefulWidget {
  const LessonS233Screen({super.key});

  @override
  State<LessonS233Screen> createState() => _LessonS233ScreenState();
}

class _LessonS233ScreenState extends State<LessonS233Screen> {

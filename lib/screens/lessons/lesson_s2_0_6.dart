...
class LessonS206Screen extends StatefulWidget {
  const LessonS206Screen({super.key});

  @override
  State<LessonS206Screen> createState() => _LessonS206ScreenState();
}

class _LessonS206ScreenState extends State<LessonS206Screen> {

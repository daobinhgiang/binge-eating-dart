...
class LessonS275Screen extends StatefulWidget {
  const LessonS275Screen({super.key});

  @override
  State<LessonS275Screen> createState() => _LessonS275ScreenState();
}

class _LessonS275ScreenState extends State<LessonS275Screen> {

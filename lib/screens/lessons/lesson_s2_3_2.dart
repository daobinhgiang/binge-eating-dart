...
class LessonS232Screen extends StatefulWidget {
  const LessonS232Screen({super.key});

  @override
  State<LessonS232Screen> createState() => _LessonS232ScreenState();
}

class _LessonS232ScreenState extends State<LessonS232Screen> {

...
class LessonS203Screen extends StatefulWidget {
  const LessonS203Screen({super.key});

  @override
  State<LessonS203Screen> createState() => _LessonS203ScreenState();
}

class _LessonS203ScreenState extends State<LessonS203Screen> {

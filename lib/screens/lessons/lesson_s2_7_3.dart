...
class LessonS273Screen extends StatefulWidget {
  const LessonS273Screen({super.key});

  @override
  State<LessonS273Screen> createState() => _LessonS273ScreenState();
}

class _LessonS273ScreenState extends State<LessonS273Screen> {

...
class LessonS227Screen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LessonS227Screen> createState() => _LessonS227ScreenState();
}

class _LessonS227ScreenState extends ConsumerState<LessonS227Screen> {
  ...
  Future<void> _loadLesson() async {
    try {
      ...
      final lesson27 = stage2.chapters[2].lessons[6]; // Chapter 2 (index 2), Lesson 7 (index 6)
  ...
  Widget build(BuildContext context) {
    ...
    if (_lesson == null || _lesson!.slides.isEmpty) {
      return Scaffold(
        appBar: AppBar(title: const Text('Lesson 2.7')),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Use our interactive meal planning tool to structure your daily eating and create balanced meal plans.',
                    ...
                    const SizedBox(height: 20),
                    ElevatedButton.icon(
                      onPressed: _startMealPlanningExercise,

...
class LessonS226Screen extends StatefulWidget {
  const LessonS226Screen({super.key});

  @override
  State<LessonS226Screen> createState() => _LessonS226ScreenState();
}

class _LessonS226ScreenState extends State<LessonS226Screen> {

...
class LessonS225Screen extends StatefulWidget {
  const LessonS225Screen({super.key});

  @override
  State<LessonS225Screen> createState() => _LessonS225ScreenState();
}

class _LessonS225ScreenState extends State<LessonS225Screen> {

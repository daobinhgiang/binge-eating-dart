...
class LessonS278Screen extends StatefulWidget {
  const LessonS278Screen({super.key});

  @override
  State<LessonS278Screen> createState() => _LessonS278ScreenState();
}

class _LessonS278ScreenState extends State<LessonS278Screen> {

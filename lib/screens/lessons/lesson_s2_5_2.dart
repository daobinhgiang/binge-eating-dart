...
class LessonS252Screen extends StatefulWidget {
  const LessonS252Screen({super.key});

  @override
  State<LessonS252Screen> createState() => _LessonS252ScreenState();
}

class _LessonS252ScreenState extends State<LessonS252Screen> {

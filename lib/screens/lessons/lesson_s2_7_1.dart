...
class LessonS271Screen extends StatefulWidget {
  const LessonS271Screen({super.key});

  @override
  State<LessonS271Screen> createState() => _LessonS271ScreenState();
}

class _LessonS271ScreenState extends State<LessonS271Screen> {
